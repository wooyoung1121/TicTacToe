...
public class Game extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		for (int x = 0; x < gameBoard.length; x++) {
			for (int y = 0; y < gameBoard.length; y++) {
				if (gameBoard[x][y] == 1) { //
					...
					g.drawLine(xLim + 10 + xDelta * x, yLim + 10 + yDelta * y, xLim + 290 + xDelta * x,
							yLim + 240 + yDelta * y);
					g.drawLine(xLim + 290 + xDelta * x, yLim + 10 + yDelta * y, xLim + 10 + xDelta * x,
							yLim + 240 + yDelta * y);
		...
		/*
		 * System.out.println(""); System.out.println(gameBoard[0][0]);
		 * System.out.println(gameBoard[0][1]); System.out.println(gameBoard[0][2]);
		 */
	}
